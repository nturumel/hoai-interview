  ...
  return (
    <div className="space-y-6">
      <div className="text-sm text-muted-foreground">
        <p>Enter invoice details below. You can edit any field by clicking the "Edit Invoice" button. The system will automatically calculate totals based on quantity and unit price.</p>
      </div>
